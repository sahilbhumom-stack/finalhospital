document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            alert('Thank you for contacting The Max Hospital! We will get back to you soon.');
    ...
    const animateElements = document.querySelectorAll('.service-card, .doctor-card, .facility-card, .stat-item');
